    ...
    <div class="navbar-right sidebar" role="navigation">
        <div class="sidebar-nav  navbar-collapse">
            ...
            <!--    <li>
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user fa-fw"></i> المدراء <b class="caret"></b>
                    </a>
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="add_admin.php"><i class="fa fa-user fa-fw"></i>  إضافة مدير </a>
                        </li>
                        <!--<li><a href="#"><i class="fa fa-gear fa-fw"></i> Settings</a>
                        </li>-->
                        <li class="divider"></li>
                        <li><a href="show_admin.php"><i class="fa fa-edit fa-fw"></i> تعديل بيانات المدراء </a>
                        </li>
                    </ul>
                </li>
