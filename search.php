    ...
    <div class="container" id="get_category_home">
        <div id='responsive-nav'>
            ...
            <ul class='main-nav nav navbar-nav'>
              ...
              <li><a href='store_company.php'>الذواكر والفلاشات</a></li>
...
<div id="aside" class="col-md-3">
    <!-- aside Widget -->
    <div id="get_category">
        <!-- <h3 class="aside-title">الشركات</h3>
 -->


        <!--       --><?php
        /*        $sql2 = "select * from company_phon where block='0'    ";
                ...
                <ul>
                      <h4>  <li class="" ><a href="phone_company.php?p='.$row2['id'].'">'.$row2['name'].'</a></li></h4>
...
$sql = "select * from pro  where id_user=5 and block='0' or name like '%$search%' or type like '%$search%' or made_in like '%$search%' or type_system like '%$search%' or version like '%$search%' or type_network like '%$search%'  or price_after_discount like '%$search%'  or type_process like '%$search%' ";
                                                  //$sql = "select * from pro  where  id_user=5 and block='0' and  name like '%$search%' or type like '%$search%' or made_in like '%$search%' or type_system like '%$search%' or version like '%$search%' or type_network like '%$search%'  or price_after_discount like '%$search%'  or type_process like '%$search%'   ";
                                                    ...
                                                    if(mysqli_num_rows($result) > 0) {
                                                        while ($row = mysqli_fetch_array($result)) {
                                                           // $im=explode(',',$row['image']);
                                                            ...
                                                            $sql2 = "select * from company_phon where id=$row[id_company] and  block='0'     ";
                                                            $result2 = mysqli_query($con, $sql2);
...
echo "
								...
								<a href='detaills_phone.php?p=".$row['id']."'><div class='product'>
									<div class='product-img'>
										<img src='../images/$row[6]' style='max-height: 170px;' alt=''>
									...
									<div class='product-body'>
									     <h3 class='product-name header-cart-item-name'><a href=''>".$row['name']."</a></h3>
         <h3 class='product-name header-cart-item-name'><a href=''>".$row['type']."</a></h3>
               <h3 class='product-name header-cart-item-name'>  <p class='product-category'>$row2[1]</p></h3>
										<h4 class='product-price header-cart-item-info'>$".$row['price_after_discount']."<del class='product-old-price'>$".$row['price']."</del></h4>
 ...
 elseif($select=='1'){
   $sql = "select * from computer where name like '%$search%' or model like '%$search%' or CPU like '%$search%' or CPUG like '%$search%' or RAM_SIZE like '%$search%' or HARD_SIZE like '%$search%' or price_after_discount like '%$search%' and id_user=5 or HARD_TYPE like '%$search%'  and block='0'  ";
                                                    $result = mysqli_query($con, $sql);
...
echo "
								...
								<a href='detaills_computer.php?p=$row[0]'><div class='product'>
									<div class='product-img'>
										<img src='../images/$row[14]' style='max-height: 170px;' alt=''>
										<div class='product-label'>
 ...
 elseif($select=='0'){
 echo '<script>alert("يرجى اختيار القسم")</script>';
...
/*
                      ...
                      <div class='product'>
                                ...
                                <div class='add-to-cart'>
                                    <button pid='70' id='product' class='add-to-cart-btn block2-btn-towishlist' href='#'><i class='fa fa-wechat'></i> ?????? ????? ????</button>
                                </div>
                            </div>
