...
$sql = " SELECT * FROM computer WHERE id = $product_id     and  block='0' " ;
if (!$con) {
...
$sql2 = "select * from company where id='$id_company'  and  block='0'     ";
...
<ul class="product-links">
								<li><h4>الوصف :</h4></li>
								<li><h4><a  href="#">'.$row['model'].' </a></h4></li>

							</ul>
							<ul class="product-links">
								<li><h4>حالة الذاكرة :</h4></li>
								<li><h4><a  href="#">'.$row['CPU'].' </a></h4></li>
...
<ul class="product-links">
								...
								<li><h4><a  href="#">'.$row['RAM_SIZE'].' </a></h4></li>
